...
export const messages: Record<string, string> = {
  ...
  'cmd.reply_mode.usage': '用法：/reply-mode chat｜topic｜shared\nchat=群内平铺回复；topic=每次 @ 都开一个独立话题+独立会话；shared=话题模式但复用同一个 session（回复落话题、共用本群会话/上下文）。',
  ...
  'cmd.reply_mode.dm_shared_unsupported': '⚠️ shared 仅对普通群有意义；私聊只支持 chat｜topic。',
